...
// IMPORTANT """"""""""  Compare the out put of prog_2(previous code) and prog_3(this code)  """""""""""
...
class Employee
{
    static int c;              //Static members are declared inside a class and defined outside the class...
    int emp_id;
...
int Employee::c;               //Static members are declared inside a class and defined outside the class...
